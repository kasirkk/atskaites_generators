...
function renderChart(rezultati, dateRange){
  ...
  // sessions inside bars and minutes above bars with outline
...
// download full HTML with embedded div (will reference CDN Plotly)
